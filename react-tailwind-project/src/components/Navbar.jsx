  ...
  return (
    <header className="flex items-center justify-between px-6 py-4 bg-white shadow-md relative z-10">
      ...
      <div className="hidden md:flex items-center space-x-4">
        <button className="border-2 px-4 py-2 rounded hover:bg-mediumGray hover:text-white focus:outline-none focus:ring-2 focus:ring-black transition">
          Login
        </button>
        ...
        <>
          ...
          <div className="fixed top-0 right-0 w-3/4 h-full bg-white p-6 z-50 shadow-lg">
            ...
            <div className="mt-4 space-y-4">
              <button className="w-full border-2  px-4 py-2 rounded hover:bg-mediumGray hover:text-white focus:outline-none focus:ring-2 focus:ring-black transition">
                Login
              </button>
              <button className="w-full border-2 border-black px-4 py-2 rounded-full hover:bg-mediumGray hover:text-white focus:outline-none focus:ring-2 focus:ring-black transition">
                Register
              </button>
            </div>
          </div>
